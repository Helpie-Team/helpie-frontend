...
{/* 모바일 헤더 */}
      <div className="w-full flex flex-row justify-between items-center sm:hidden p-4 border-b border-grayScale-100">
        <div className="flex flex-row items-center gap-2">
          ...
          <h1 className="text-body1-sb">후기 작성</h1>
        </div>
        ...
        <button
          ...
          className={`px-[14px] py-[10px] rounded-full font-medium transition-all ${
      ...
      <div className="bg-grayScale-50 rounded-2xl ">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-body1 font-semibold">모임완료</h2>
          {groupData && (
        ...
        {isLoadingGroup ? (
          <div className="text-body2-regular text-grayScale-500">
            모임 정보를 불러오는 중...
          </div>
        ) : groupData ? (
          <div className="flex items-start gap-4">
            <div className="w-16 h-16 bg-gray-300 rounded-lg overflow-hidden flex-shrink-0 relative">
              <Image
                src={
                  groupData.thumbnail &&
                  typeof groupData.thumbnail === 'string' &&
                  groupData.thumbnail.trim() !== ''
                    ? groupData.thumbnail
                    : noImage
                }
                alt="모임 이미지"
            ...
            <div className="flex-1 flex flex-col items-start gap-1">
              <h3 className="text-body1 line-clamp-1">
                {groupData.title}
              </h3>

              <p className="text-caption1-regular text-grayScale-700 line-clamp-2">
                {groupData.description}
              </p>

              <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-caption1-regular text-grayScale-500">
      ...
      <div className="flex flex-col gap-3">
        <h2 className="text-body1 font-semibold">
          참여하신 모임은 어떠셨나요?
        </h2>
        <div className="flex items-center gap-3">
          ...
          {rating > 0 && (
            <span className="text-caption1-regular text-grayScale-700">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2">
          <textarea
            ...
            placeholder="느낀점이나 이용 시 좋은 팁을 말해주세요!"
            maxLength={500}
            className="
              w-full h-40
              px-4 py-3
              border border-grayScale-200 bg-white rounded-xl
              text-body2
              resize-none
              focus:outline-none focus:border-key-100
            "
          />
          ...
          <div className="flex flex-col gap-1 text-caption1-b text-grayScale-500 bg-[#FDF3EF] rounded-xl px-4 py-3">
            <p>• 모임과 무관한 내용 혹은 동일한 문자와 같은 내용은 삭제될 수 있습니다.</p>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-2">
          <h2 className="text-body1 font-semibold">사진 공유하기</h2>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-wrap gap-3">
            ...
            {images.map((image, index) => (
              <div
                key={index}
                className="relative w-[44%] max-w-[180px] aspect-square"
              >
                <Image
            ...
            {/* 업로드 버튼 - 3장 미만일 때만 표시 */}
            {images.length < 3 && (
              <label className="w-[60%] max-w-[220px] aspect-square border-2 border-grayScale-200 bg-white rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-key-100 transition-colors gap-2">
                <input
                  type="file"
                  accept="image/*"
                  multiple
                ...
                <Image
                  ...
                  height={40}
                />
                <span className="text-body3-regular text-grayScale-500">
                  사진 업로드하기
                </span>
              </label>
            )}
      ...
      <div className="flex items-start gap-3">
        ...
        <Label
          htmlFor="terms-2"
          className="text-body2-regular text-grayScale-600 cursor-pointer"
        >
          닉네임 비공개로 작성
        </Label>
      </div>
