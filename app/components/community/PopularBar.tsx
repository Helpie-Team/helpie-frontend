...
export function PopularBar() {
  ...
  return (
    <aside className="w-[260px]">
      <div className="sticky top-8 hidden sm:flex flex-col rounded-3xl border border-gray-100 bg-white px-5 py-4 shadow-sm max-h-[calc(100vh-4rem)] overflow-y-auto">
        {/* 헤더 */}
