...
export default function ModalForm({ email, socialAccessToken, socialType}: ModalFormProps) {
  ...
  const handlePrivacyPolicyChange = (checked: boolean) => {
    const newAgreements = { ...agreements, privacyPolicy: checked };
    newAgreements.all = newAgreements.privacyPolicy && newAgreements.locationInfo && newAgreements.marketing;
    setAgreements(newAgreements);
  };

  const handleLocationInfoChange = (checked: boolean) => {
    const newAgreements = { ...agreements, locationInfo: checked };
    newAgreements.all = newAgreements.privacyPolicy && newAgreements.locationInfo && newAgreements.marketing;
    setAgreements(newAgreements);
  };

  const handleMarketingChange = (checked: boolean) => {
    const newAgreements = { ...agreements, marketing: checked };
    newAgreements.all = newAgreements.privacyPolicy && newAgreements.locationInfo && newAgreements.marketing;
    setAgreements(newAgreements);
  };
